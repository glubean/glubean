...
// =============================================================================
// Legacy flow types — DELETED with contract.flow() (Nv1-D2, 2026-06-13).
// FieldMapping survives: it is the lens-tracer output shape (extractMappings /
// extractMappingsOut in contract-core), kept for the Nv3 call in/out mapping
// projection.
// =============================================================================
...
// =============================================================================
// Registry metadata (embedded in RegisteredTestMeta.contract)
// =============================================================================
