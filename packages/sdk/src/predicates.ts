 ...
 * `expect[]`, inbound correlate paths) and by `test()` helpers. The legacy
 * `contract.flow()` step shapes that used to live here were deleted with the
 * flow itself (Nv1-D2).
 *
...
// =============================================================================
// Opaque predicate + JSON-safe predicate projection
// =============================================================================
