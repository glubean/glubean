 ...
 * If any type inference breaks, `tsc --noEmit` will catch it.
 */
...
// Vitest wrapper — just ensure the file is included in the test run
vitest_test("type tests compile successfully", () => {
  // This test exists only to make vitest pick up this file.
  // The real validation is that TypeScript compiles this file without errors.
});
