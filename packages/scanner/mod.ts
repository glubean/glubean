...
export { isSpecVersionSupported, SPEC_VERSION, SUPPORTED_SPEC_VERSIONS } from "./spec.ts";

// Re-export types
export type { BundleMetadata, ExportMeta, FileMeta, ScanOptions, ScanResult, ValidationResult } from "./types.ts";
...
import type { ScanOptions, ScanResult, ValidationResult } from "./types.ts";
