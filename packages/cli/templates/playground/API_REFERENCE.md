...
> This is a compact reference designed for AI agents (Cursor, Claude Code, Codex). Full docs: https://dummyjson.com/docs
...
- All CRUD mutations (POST/PUT/DELETE) are **simulated** — they return realistic responses but don't persist data on the
  server.
